               ...
               >
                  <S.CurrencyIcon>
                     <Image
                        width="50"
                        height="50"
                        src={currency.chain_image}
                        alt={currency.chain_code}
                        style={{
                           filter: `brightness(${currency.chain_code === 'TRC20' && theme === 'light' ? 0 : 1})`,
                        }}
                     />
                  </S.CurrencyIcon>
                  <S.CurrencyRadio />
                  <S.CurrencyLogo type={currency.id}>
                     <Image
                        width="50"
                        height="50"
                        src={currency.asset_image}
                        alt={currency.asset_name}
                        style={{
                           filter: `brightness(${currency.asset_name === 'USDT' && theme === 'light' ? 0 : 1})`,
                        }}
                     />
                  </S.CurrencyLogo>
                  <S.CurrencyTextWrapper>
                     <S.CurrencyTitle>{currency.asset_name}</S.CurrencyTitle>
                     <S.CurrencySubtitle>{currency.chain_code}</S.CurrencySubtitle>
                  </S.CurrencyTextWrapper>
               </S.Currency>
            ))}
      </S.CurrencyWrapper>
